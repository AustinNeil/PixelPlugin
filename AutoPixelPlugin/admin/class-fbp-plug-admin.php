...
class Fbp_Plug_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Fbp_Plug_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Fbp_Plug_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/fbp-plug-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/fbp-plug-admin.js', array( 'jquery' ), $this->version, false );

	}

	public function add_plugin_admin_menu() {

    // Add a settings page for this plugin to the Admin->Plugin->Settings menu.
    add_options_page( 'Facebook Pixel Injector', 'Facebook Pixel', 'manage_options', $this->plugin_name, array($this, 'display_plugin_setup_page'));
