...
<div class="wrap">
    ...
    <form method="post" name="cleanup_options" action="options.php">
        ...
        <!-- Add facebook Pixel information to <head> -->
        <fieldset>
            <legend class="screen-reader-text"><span>Add Pixel Script</span></legend>
            <label for="<?php echo $this->plugin_name; ?>-inject">
                <input type="text" id="<?php echo $this->plugin_name; ?>" name="<?php echo $this->plugin_name; ?> [inject]" value="1"/>
                <span><?php esc_attr_e('Add Pixel Script', $this->plugin_name); ?></span>
            </label>
        </fieldset>
